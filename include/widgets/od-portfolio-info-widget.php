<?php
	/**
	 * ordainit-toolkit Portfolio Info Widget
	 *
	 *
	 * @author 		Theme_Pure
	 * @category 	Widgets
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'od_portfolio_info_widget');
	function od_portfolio_info_widget() {
		register_widget('od_portfolio_info_widget');
	}
	
	
	class od_portfolio_info_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('od_portfolio_info_widget',esc_html__('Solvra Portfolio Info','ordainit-toolkit'),array(
				'description' => esc_html__('Solvra Portfolio Info Widget by Theme_Pure','ordainit-toolkit'),
			));
		}
