<?php 
Class OD_Services_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('od-services-list', 'Solvra Services List', array(
			'description'	=> 'Solvra Services List'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('OD_Services_List_Widget');
});