<?php
	...
	class Bdevs_Subscriber_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('bdevs_subscriber_widget',esc_html__('Solvra Footer Subscriber','tocore'),array(
		...
		?>
			...
			<div class="od-footer-subscribe-area position-relative">
				<div class="od-footer-subscribe-shape"></div>
				<div class="container">
					<div class="od-footer-subscribe-bg theme-yellow-bg pt-30 pb-20 z-index">
						<div class="row align-items-center">
							...
							<div class="col-xl-7 col-lg-8">
								<div class="od-footer-subscribe-form">
