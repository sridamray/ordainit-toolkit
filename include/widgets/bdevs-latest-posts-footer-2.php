...
Class Latest_posts_footer2_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts2-footer', 'Solvra Footer 2 Posts Image', array(
			'description'	=> 'Latest Post Widget by Solvra'
		));
	}
	...
	public function widget($args, $instance){
     	...
     	<?php endif; ?>
	     	...
	     	<div class="od-footer-news od-footer-news-three">
				...
				?>
		            <div class="od-footer-news-single od-footer-news-three-single mb-10">
		                <div class="od-footer-news-three-single-img bg-blend">
		                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('thumbnail'); ?></a>
		                </div>
		                <div class="od-footer-news-three-single-text">
